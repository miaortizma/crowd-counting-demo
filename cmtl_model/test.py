...
data_path =  './data/original/shanghaitech/part_' + part + '_final/test_data/images/'
gt_path = './data/original/shanghaitech/part_' + part + '_final/test_data/ground_truth_csv/'
